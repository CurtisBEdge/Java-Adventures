...
public class StarterText {
    ...
    public static void starterText() {
        ...
        starterText.add("The map shows details of a buried treasure on Skull Island, but is incomplete. You must sail the seas and find more clues to guide you to the treasure.");
        ...
        starterText.add("Anytime you can CHECK what you have in your INVENTORY or how many SUPPLIES remain on your ship.");
